    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="event_update.php?id=<?php echo $id?>" method="post">
					  ...
					  <div class="control-group <?php echo !empty($locationError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="event_location" type="text"  placeholder="Location" value="<?php echo !empty($location)?$mobile:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($descriptionError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="event_description" type="text"  placeholder="Description" value="<?php echo !empty($description)?$mobile:'';?>">
